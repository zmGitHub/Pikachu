...
import { Col, Button, Form, Radio, InputNumber } from 'antd';
...
class LoginSetting extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    const setting = nextProps.setting;
    const define = this.getDefine(setting);
    this.setState({
  ...
  getDefine(setting) {
    ...
    const beforeShowVerificationCodeDefine = _.indexOf(beforeShowVerificationCodeLists, setting.beforeShowVerificationCode) > -1 ? 0 : setting.beforeShowVerificationCode;
    const beforeFreezeDefine = _.indexOf(beforeFreezeLists, setting.beforeFreeze) > -1 ? 0 : setting.beforeFreeze;
    const freezeTimeDefine = _.indexOf(freezeTimeLists, setting.freezeTime) > -1 ? 0 : setting.freezeTime;
